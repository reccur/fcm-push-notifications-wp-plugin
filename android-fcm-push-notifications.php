<?php
/**
 * Plugin Name: Android FCM Push Notifications
 * Plugin URI: https://github.com/reccur/android-fcm-push-notifications
 * Description: Android FCM Push Notifications is a plugin through which you can send push notifications directly from your WordPress site to android devices via Firebase Cloud Messaging (FCM) service. When a new blog is posted or existing blog is updated, a push notification sent to android device. Just set your topic!
 * Author: Nishan Hitang
 * Author URI: https://nishanhitang.com.np
 * Version: 1.0
 * Text Domain: android-fcm-push-notifications
 ...
 * @GitHub https://github.com/reccur/android-fcm-push-notifications
 */
